...
export default function BounceCards({
  ...
  const pushSiblings = (hoveredIdx: number) => {
    ...
    // If hovering the same card, skip
    if (currentHoverIdxRef.current === hoveredIdx) return;
    currentHoverIdxRef.current = hoveredIdx;
  ...
  const resetSiblings = () => {
    ...
    // Add a small delay to prevent jitter when quickly moving between cards
