...
export default function ServicesListModal({
  ...
  return createPortal(
    ...
    >
      ...
      {/* Modal */}
      <div
        className={`relative z-[101] w-full max-w-6xl max-h-[90vh] rounded-2xl border border-white/30 bg-black p-4 sm:p-6 md:p-8 shadow-2xl backdrop-blur-xl transition-all duration-300 overflow-hidden flex flex-col ${
          isOpen
      ...
      >
        ...
        <div className="mb-4 sm:mb-6 pr-8 sm:pr-10">
          <h2 className="text-2xl sm:text-3xl font-light text-white">Full Services List</h2>
            ...
            <table className="w-full border-collapse">
              <thead className="sticky top-0 bg-black/95 z-10">
                <tr className="border-b border-white/20">
                  <th className="text-left py-2 px-2 sm:py-3 sm:px-4 text-xs sm:text-sm font-medium text-white/80">
                    Service Category
                  </th>
                  <th className="text-left py-2 px-2 sm:py-3 sm:px-4 text-xs sm:text-sm font-medium text-white/80">
              ...
              <tbody>
                {services.map((service, index) => (
                  ...
                  >
                    <td className="py-2 px-2 sm:py-3 sm:px-4 text-xs sm:text-sm text-white/90 font-medium transition-colors duration-300 group-hover:text-black">
                      {service.category}
                    </td>
                    <td className="py-2 px-2 sm:py-3 sm:px-4 text-xs sm:text-sm text-white/80 transition-colors duration-300 group-hover:text-black">
                      {service.service}
                    </td>
                    <td className="py-2 px-2 sm:py-3 sm:px-4 text-xs sm:text-sm text-white/70 transition-colors duration-300 group-hover:text-black/80">
                      {service.solves}
                    </td>
                    <td className="py-2 px-2 sm:py-3 sm:px-4 text-xs sm:text-sm text-white/70 transition-colors duration-300 group-hover:text-black/80">
                      {service.buyers}
